...
public class ConfirmAddress2 extends AppCompatActivity {
    ...
    Button btn_xacnhan;
    String nameCity, nameDistrict, nameWard, nameDetailLocation, Typeauthor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeauthor = intent1.getStringExtra("TypeAuthor");
...
//        lấy giá trị địa chỉ đã lưu
        ...
        arrayAdapterCity = new ArrayAdapter<>(ConfirmAddress2.this, R.layout.support_simple_spinner_dropdown_item, cityList);
    ...
    public void loadDistrict() {
        ...
        cityAuto.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                ArrayAdapter<String> arrayAdapterDistrict = new ArrayAdapter<>(ConfirmAddress2.this, R.layout.support_simple_spinner_dropdown_item, districList);
    ...
    public void loadCommune() {
        districtAuto.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                ArrayAdapter<String> arrayAdapterCommune = new ArrayAdapter<>(ConfirmAddress2.this, R.layout.support_simple_spinner_dropdown_item, communeList);
