...
//        lấy giá trị địa chỉ đã lưu
        ...
        arrayAdapterCity = new ArrayAdapter<>(ConfirmAddress.this, R.layout.support_simple_spinner_dropdown_item, cityList);
    ...
    public void loadDistrict() {
        ...
        cityAuto.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                ArrayAdapter<String> arrayAdapterDistrict = new ArrayAdapter<>(ConfirmAddress.this, R.layout.support_simple_spinner_dropdown_item, districList);
    ...
    public void loadCommune() {
        districtAuto.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                ArrayAdapter<String> arrayAdapterCommune = new ArrayAdapter<>(ConfirmAddress.this, R.layout.support_simple_spinner_dropdown_item, communeList);
